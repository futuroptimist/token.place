...
OBSERVABILITY_ROUTES = {("GET", "/api/v1/relay/availability")}

DOCUMENTED_INTERNAL_ROUTES = (
    COMPUTE_NODE_CONTROL_PLANE_ROUTES | INTERNAL_RELAY_LIFECYCLE_ROUTES | OBSERVABILITY_ROUTES
)
