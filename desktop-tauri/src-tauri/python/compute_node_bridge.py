...
def run(args: argparse.Namespace) -> int:
    ...
    if callable(reconcile_model_path):
        runtime.model_manager.model_path = reconcile_model_path(args.model)
    elif getattr(runtime.model_manager, "allow_test_model_path_override", False) is True:
        # Narrow compatibility seam for the lightweight unit-test manager only.
        runtime.model_manager.model_path = args.model
    else:
        raise RuntimeError("configured_model_path_reconciliation_unavailable")
