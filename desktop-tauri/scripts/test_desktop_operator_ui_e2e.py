...
def _benchmark_tokenizer_app_args(request: Path, evidence: Path) -> list[str]:
    return [
...
def run_long_context_packaged_mode(request_path: Path, evidence_path: Path,
    ...
    try:
        ...
        driver = start_driver(
            ...
            _benchmark_tokenizer_app_args(tokenizer_request, tokenizer_evidence),
        )
