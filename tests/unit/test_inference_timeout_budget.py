...
def test_upgraded_inference_deadlines_preserve_legacy_300_second_boundary():
    ...
    assert "const LEGACY_RELAY_RESPONSE_POLL_TIMEOUT_MS = 485000;" in chat_js
    assert "const RELAY_RESPONSE_PROPAGATION_GRACE_MS = 5000;" in chat_js
    assert "const RELAY_RESPONSE_POLL_TIMEOUT_MS" not in chat_js
