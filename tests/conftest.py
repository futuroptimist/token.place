...
FOCUSED_RELAY_E2E_NODEIDS = {
    ...
    "tests/e2e/test_ui.py::test_landing_chat_sticky_compute_node_two_turns_and_server_key_label",
...
def _is_focused_relay_landing_chat_request(request: pytest.FixtureRequest) -> bool:
    ...
    target_names = {
        ...
        "landing_chat_sticky_compute_node_two_turns_and_server_key_label",
        "sticky",
        "server_key",
