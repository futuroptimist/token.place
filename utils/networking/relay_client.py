...
_SAFE_WORKER_DIAGNOSTIC_REDACTED_SUMMARY_RE = re.compile(
    ...
    r"rope_yarn_eval_failure|unsupported_kwarg|prompt_tokenization_failure|prompt_eval_failure|prompt_eval_decode_failure|prompt_eval_backend_failure|prompt_eval_invalid_token_failure|prompt_eval_state_failure|prompt_eval_context_failure|sampling_failure)$"
)
...
def _safe_worker_diagnostic_value(key: str, value: Any) -> Any:
    ...
    if key in {"attempted_generation_kwargs", "attempted_plain_completion_methods", "plain_completion_attempt_methods", "plain_completion_attempt_categories", "plain_completion_attempt_exception_types", "plain_completion_attempt_safe_summaries", "plain_completion_attempt_rejected_kwargs", "plain_completion_attempt_result_shapes", "plain_completion_attempt_tokenization_variants", "plain_completion_prompt_tokenization_variant_ids", "plain_completion_prompt_tokenization_token_counts", "plain_completion_prompt_tokenization_special_values", "plain_completion_prompt_tokenization_selected_variant"}:
