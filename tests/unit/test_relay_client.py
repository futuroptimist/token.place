...
def test_api_v1_deadline_metadata_uses_smaller_and_never_extends(monkeypatch):
    ...
    # A completion after the obsolete five-minute boundary remains inside the
    # worker's production fallback budget when deadline metadata is absent.
    now['value'] = 1301.0
    assert now['value'] < 1480.0
