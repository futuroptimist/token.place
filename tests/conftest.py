...
FOCUSED_RELAY_E2E_NODEIDS = {
    ...
    "tests/e2e/test_ui.py::test_landing_first_paint_preserves_chat_layout_when_chat_js_is_delayed",
    ...
    "tests/e2e/test_ui.py::test_landing_hydration_populates_status_and_models_without_large_layout_jump",
    "tests/e2e/test_ui.py::test_compute_node_status_reserves_space_when_loading_label_is_blank",
...
def _is_focused_relay_landing_chat_request(request: pytest.FixtureRequest) -> bool:
    ...
    target_names = {
        ...
        "landing_first_paint_preserves_chat_layout_when_chat_js_is_delayed",
        "landing_hydration_populates_status_and_models_without_large_layout_jump",
        "compute_node_status_reserves_space_when_loading_label_is_blank",
