...
FOCUSED_RELAY_E2E_NODEIDS = {
    ...
    "tests/e2e/test_ui.py::test_landing_first_paint_hides_vue_template_variables_when_chat_js_blocked",
...
def _is_focused_relay_landing_chat_request(request: pytest.FixtureRequest) -> bool:
    ...
    target_names = {
        ...
        "landing_first_paint_hides_vue_template_variables_when_chat_js_blocked",
        "hydration",
        "pop",
        "cloak",
        "compute_node_count",
