...
The bounded public-quota counter and its downstream alert/evidence contract are documented in
[Public quota pressure telemetry](../ops/public-quota-telemetry.md).
