  ...
  return (
    <main style={{ maxWidth: 820, margin: '20px auto', fontFamily: 'sans-serif' }}>
      ...
      <section style={{ marginTop: 14, border: '1px solid #ddd', padding: 12 }}>
        ...
        <p style={{ marginTop: 0, fontSize: 12, color: '#555' }}>
          Applies only to 64K and requires stopping and restarting the operator. Balanced: 512/256; Safe: 256/128; Experimental: 1024/512. Experimental can increase memory use or instability.
        </p>
        <div style={{ display: 'flex', gap: 8 }}>
