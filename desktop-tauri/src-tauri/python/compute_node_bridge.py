...
def _startup_qwen_64k_batch_profile(args: argparse.Namespace) -> str:
    value = getattr(args, "qwen_64k_batch_profile", None)
...
def run(args: argparse.Namespace) -> int:
    ...
    runtime.model_manager.qwen_64k_batch_profile_requested = args.qwen_64k_batch_profile
...
def installed_context_smoke_payload(context_tier: str, launch_number: str, qwen_64k_batch_profile: str = "balanced") -> Dict[str, Any]:
    ...
    with tempfile.TemporaryDirectory(prefix="tokenplace-installed-context-") as tmpdir:
        ...
        manager.qwen_64k_batch_profile_requested = _startup_qwen_64k_batch_profile(
            argparse.Namespace(qwen_64k_batch_profile=qwen_64k_batch_profile)
        )
