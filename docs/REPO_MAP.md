...
- `desktop-tauri/` — Tauri MVP desktop client scaffold for local inference sidecar flows.
  - Includes backend detection, sidecar streaming/cancel wiring, and encrypted relay forwarding.
