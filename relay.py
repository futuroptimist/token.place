...
def next_server():
    """Deprecated legacy endpoint retained for explicit compatibility failures."""
    return jsonify({
        'error': {
...
def sink():
    ...
    return jsonify({
        'error': {
            'message': 'Legacy relay endpoint deprecated. Use /api/v1/relay/servers/register and /api/v1/relay/servers/poll.',
            'code': 410,
            'type': 'deprecated_endpoint',
        }
    }), 410
