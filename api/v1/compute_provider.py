...
_RELAY_ERROR_MAP: dict[str, dict[str, Any]] = {
    "api_v1_relay_disabled": {
        ...
        "public_message": "Distributed API v1 relay is temporarily disabled for security hardening.",
        "status_code": 503,
    },
...
class DistributedApiV1ComputeProvider:
    """Provider placeholder that fails closed while relay API v1 plaintext is disabled."""
    ...
    def complete_chat(
        ...
        *,
        ...
        raise _error_from_code(
            "api_v1_relay_disabled",
            message=(
                "distributed provider is disabled until relay API v1 restores "
