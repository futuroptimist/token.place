...
use crate::batch_profiles::{default_qwen_64k_batch_profile, normalize_qwen_64k_batch_profile};
...
mod tests {
    ...
    #[test]
    fn desktop_config_normalizes_unknown_context_tier_to_default() {
        let config: DesktopConfig = serde_json::from_str::<DesktopConfig>(
            r#"{
    ...
    #[test]
    fn desktop_config_normalizes_unknown_batch_profile_to_balanced() {
        let config: DesktopConfig = serde_json::from_str::<DesktopConfig>(
            r#"{"qwen_64k_batch_profile":"unknown"}"#,
        )
        .expect("config should deserialize")
        .normalized();
