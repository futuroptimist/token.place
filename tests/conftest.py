...
FOCUSED_RELAY_E2E_NODEIDS = {
    ...
    "tests/e2e/test_ui.py::test_landing_chat_system_message_is_request_only_and_affects_auto_context",
    "tests/e2e/test_ui.py::test_landing_chat_auto_context_retry_reuses_complete_system_message_array",
    "tests/e2e/test_ui.py::test_landing_chat_send_once_fallback_builds_system_message_request",
    "tests/e2e/test_ui.py::test_landing_chat_real_browser_encryption_hides_system_and_conversation_from_relay",
