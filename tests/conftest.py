...
FOCUSED_RELAY_E2E_NODEIDS = {
    ...
    "tests/e2e/test_ui.py::test_landing_chat_deadline_helpers_follow_metadata_without_extension",
    "tests/e2e/test_ui.py::test_landing_chat_valid_admission_ttl_expires_and_cancels_once",
    "tests/e2e/test_ui.py::test_landing_chat_cancellation_http_failure_is_one_coherent_warning",
    "tests/e2e/test_ui.py::test_landing_chat_cancellation_network_failure_is_visible",
