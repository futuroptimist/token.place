...
current token.place chart source is `0.1.7`; Sugarkube `docs/apps/tokenplace.version`
should pin `0.1.7` unless an operator explicitly documents why a different
