"""Regression tests ensuring API v1 exposes the canonical Qwen3 8B model."""
...
@mock.patch.dict(os.environ, {"USE_MOCK_LLM": "1"})
def test_qwen_catalog_targets_default_q4_k_m_release():
    import api.v1.models as models
...
def test_qwen3_profile_is_public_catalog_default():
