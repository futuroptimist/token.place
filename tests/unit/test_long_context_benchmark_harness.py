...
def desktop_runner():
    ...
    names = {"_wait_for_packaged_setup_condition", "_prepare_packaged_landing_page",
        ...
        "_read_primary_tokenizer_observation", "_benchmark_tokenizer_app_args"}
...
def test_packaged_tokenizer_handoff_uses_explicit_application_arguments(
        desktop_runner, tmp_path):
    request = tmp_path / "request.json"
    evidence = tmp_path / "evidence.json"

    assert desktop_runner._benchmark_tokenizer_app_args(request, evidence) == [
        "--token-place-benchmark-tokenizer-request", str(request),
        "--token-place-benchmark-tokenizer-evidence", str(evidence),
    ]
