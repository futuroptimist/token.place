    ...
    <main style={{ maxWidth: 820, margin: '20px auto', fontFamily: 'sans-serif' }}>
      ...
      <section style={{ marginTop: 14, border: '1px solid #ddd', padding: 12 }}>
        ...
        <p id="qwen-64k-batch-profile-help" style={{ marginTop: 0, fontSize: 12, color: '#555' }}>
          Balanced: 512/256. Safe: 256/128. Experimental: 1024/512 and can increase memory use or instability.
          {config.context_tier === '64k-full' ? ' Changes require stopping and restarting the operator.' : ' Inactive for the 8K tier; your saved 64K preference is preserved.'}
        </p>
        <div style={{ display: 'flex', gap: 8 }}>
