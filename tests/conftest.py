...
FOCUSED_RELAY_E2E_NODEIDS = {
    ...
    "tests/e2e/test_ui.py::test_landing_hydration_fills_dynamic_fields_without_large_layout_jump",
    ...
    "tests/e2e/test_ui.py::test_compute_node_status_keeps_blank_loading_footprint",
