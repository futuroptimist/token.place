    ...
    <main style={{ maxWidth: 820, margin: '20px auto', fontFamily: 'sans-serif' }}>
      ...
      <section style={{ marginTop: 14, border: '1px solid #ddd', padding: 12 }}>
        ...
        <label htmlFor="qwen-64k-batch-profile" style={{ display: 'block', marginBottom: 8 }}>
          ...
          <select
            ...
            onChange={(event) => updateConfig({
              ...config,
              qwen_64k_batch_profile: normalizeQwen64kBatchProfile(event.target.value),
            })}
            style={{ display: 'block', marginTop: 4 }}
          >
        ...
        <p id="qwen-64k-batch-profile-help" style={{ marginTop: 0, fontSize: 12, color: '#555' }}>
          {config.context_tier === '64k-full'
            ? 'Balanced: 512/256. Safe: 256/128. Experimental: 1024/512 and may increase memory use or instability. Changes require stopping and restarting the operator.'
            : 'Only applies to the 64K Full tier; the saved preference is not applied to 8K. Changes require stopping and restarting the operator.'}
        </p>
        <div style={{ display: 'flex', gap: 8 }}>
